...
public:
	CSphereMeshDiffused(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, 
		float fRadius = 2.0f, int nSlices = 20, int nStacks = 20, XMFLOAT4 xmf4Color = XMFLOAT4(0.2f, 0.0f, 0.0f, 0.8f));
	virtual ~CSphereMeshDiffused();
};

class CBarrierMeshDiffused : public CMesh
{
public:
	CBarrierMeshDiffused(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList,
		float fRadius = 2.0f, int nSlices = 20, int nStacks = 20, XMFLOAT4 xmf4Color = XMFLOAT4(0.8f, 0.4f, 0.0f, 0.8f));
	virtual ~CBarrierMeshDiffused();
};