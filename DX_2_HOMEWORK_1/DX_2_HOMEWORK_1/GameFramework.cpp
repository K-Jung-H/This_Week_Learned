...
void CGameFramework::BuildObjects()
{
	...
	if (rendering_scene) 
		rendering_scene->ReleaseUploadBuffers();
...
void CGameFramework::ProcessInput()
{
	...
	if (GetKeyboardState(pKeysBuffer) && rendering_scene) 
		bProcessedByScene = rendering_scene->ProcessInput(pKeysBuffer);
...
{
	if (rendering_scene) 
		rendering_scene->AnimateObjects(m_GameTimer.GetTimeElapsed());
}
...
{    
	...
	rendering_scene->Render(m_pd3dCommandList, m_pCamera);
