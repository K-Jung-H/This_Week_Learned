...
void CScene::BuildObjects(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList)
{
	...
	float fHalfWidth = 100.0f, fHalfDepth = 300.0f;

	CPlaneMesh* pboard = new CPlaneMesh(pd3dDevice, pd3dCommandList, fHalfWidth * 2.0f, fHalfDepth * 2.0f, XMFLOAT4(0.4f, 0.3f, 0.1f, 0.0f));
	...
	StoneObject* pWhiteObject = NULL;

	pWhiteObject = new StoneObject(pd3dDevice, pd3dCommandList);
	pWhiteObject->SetMesh((CMesh*)pWhiteStoneMesh);
	pWhiteObject->SetPosition(-50, 5, 100);
	pWhiteObject->SetFriction(2);
	pWhiteObject->SetRotationAxis(XMFLOAT3(0.0f, 1.0f, 0.0f));
	pWhiteObject->SetRotationSpeed(0.0f);
	pWhiteObject->SetMovingDirection(XMFLOAT3(0.0f, 0.0f, -1.0f));
	pWhiteObject->SetMovingSpeed(0.0f);
	pWhiteObject->player_team = true;
	m_ppGameObjects[i++] = pWhiteObject;
	
	pWhiteObject = new StoneObject(pd3dDevice, pd3dCommandList);
	pWhiteObject->SetMesh((CMesh*)pWhiteStoneMesh);
	pWhiteObject->SetPosition(0, 5, 100);
	pWhiteObject->SetFriction(2);
	pWhiteObject->SetRotationAxis(XMFLOAT3(0.0f, 1.0f, 0.0f));
	pWhiteObject->SetRotationSpeed(0.0f);
	pWhiteObject->SetMovingDirection(XMFLOAT3(0.0f, 0.0f, -1.0f));
	...
	pWhiteObject = new StoneObject(pd3dDevice, pd3dCommandList);
	pWhiteObject->SetMesh((CMesh*)pWhiteStoneMesh);
	pWhiteObject->SetPosition(25, 5, 150);
	pWhiteObject->SetFriction(2);
	pWhiteObject->SetRotationAxis(XMFLOAT3(0.0f, 1.0f, 0.0f));
	pWhiteObject->SetRotationSpeed(0.0f);
	pWhiteObject->SetMovingDirection(XMFLOAT3(0.0f, 0.0f, -1.0f));
	...
	StoneObject* pBlackObject = NULL;
	
	pBlackObject = new StoneObject(pd3dDevice, pd3dCommandList);
	pBlackObject->SetMesh((CMesh*)pBlackStoneMesh);
	pBlackObject->SetPosition(-50, 5, -100);
	pBlackObject->SetFriction(2);
	pBlackObject->SetRotationAxis(XMFLOAT3(0.0f, 1.0f, 0.0f));
	pBlackObject->SetRotationSpeed(0.0f);
	pBlackObject->SetMovingDirection(XMFLOAT3(0.0f, 0.0f, 1.0f));
	pBlackObject->SetMovingSpeed(0.0f);
	m_ppGameObjects[i++] = pBlackObject;

	pBlackObject = new StoneObject(pd3dDevice, pd3dCommandList);
	pBlackObject->SetMesh((CMesh*)pBlackStoneMesh);
	pBlackObject->SetPosition(0, 5, -100);
	pBlackObject->SetFriction(2);
	pBlackObject->SetRotationAxis(XMFLOAT3(0.0f, 1.0f, 0.0f));
	pBlackObject->SetRotationSpeed(0.0f);
	pBlackObject->SetMovingDirection(XMFLOAT3(0.0f, 0.0f, 1.0f));
	...
	pBlackObject = new StoneObject(pd3dDevice, pd3dCommandList);
	pBlackObject->SetMesh((CMesh*)pBlackStoneMesh);
	pBlackObject->SetPosition(25, 5, -150);
	pBlackObject->SetFriction(2);
	pBlackObject->SetRotationAxis(XMFLOAT3(0.0f, 1.0f, 0.0f));
	pBlackObject->SetRotationSpeed(0.0f);
	pBlackObject->SetMovingDirection(XMFLOAT3(0.0f, 0.0f, 1.0f));
...
void CScene::Render(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, CCamera* pCamera)
{
	...
	m_pShaders[0].Render(pd3dCommandList, pCamera);
