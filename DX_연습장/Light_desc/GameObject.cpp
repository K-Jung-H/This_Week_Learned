...
XMFLOAT3 CGameObject::GetLook() // 게임 객체의 로컬 z-축 벡터를 반환 
{
	return(Vector3::Normalize(XMFLOAT3(m_xmf4x4World._31, m_xmf4x4World._32, m_xmf4x4World._33)));
}

XMFLOAT3 CGameObject::GetUp() // 게임 객체의 로컬 y-축 벡터를 반환
{
	return(Vector3::Normalize(XMFLOAT3(m_xmf4x4World._21, m_xmf4x4World._22, m_xmf4x4World._23)));
}

XMFLOAT3 CGameObject::GetRight() // 게임 객체의 로컬 x-축 벡터를 반환
{
	return(Vector3::Normalize(XMFLOAT3(m_xmf4x4World._11, m_xmf4x4World._12, m_xmf4x4World._13)));
}

void CGameObject::MoveStrafe(float fDistance) // 게임 객체를 로컬 x-축 방향으로 이동
{
...
void CGameObject::MoveUp(float fDistance) // 게임 객체를 로컬 y-축 방향으로 이동
{
	XMFLOAT3 xmf3Position = GetPosition();
...
void CGameObject::MoveForward(float fDistance) //게임 객체를 로컬 z-축 방향으로 이동
{
	XMFLOAT3 xmf3Position = GetPosition();
...
void CGameObject::Rotate(float fPitch, float fYaw, float fRoll) //게임 객체를 주어진 각도로 회전
{
