...
{
	return(CShader::CompileShaderFromFile(L"UI.hlsl", "VSMain", "vs_5_1", ppd3dShaderBlob));
}

D3D12_SHADER_BYTECODE UIShader::CreatePixelShader(ID3DBlob** ppd3dShaderBlob)
{
	return(CShader::CompileShaderFromFile(L"UI.hlsl", "PSMain", "ps_5_1", ppd3dShaderBlob));
}
